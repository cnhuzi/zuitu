...
window.x_init_hook_editor = function() {
	...
	jQuery('textarea.editor').each(function(){
			KE.show({id : jQuery(this).attr('id'), resizeMode : 1, allowFileManager:true,allowPreviewEmoticons : false, allowUpload : true, imageUploadJson: WEB_ROOT+'/kindupload.php', fileManagerJson: WEB_ROOT+'/filemanager.php', items : ['textcolor', 'bgcolor', 'bold', 'italic', 'underline', 'removeformat', '|', 'justifyleft', 'justifycenter', 'justifyright', 'insertorderedlist', 'insertunorderedlist', '|', 'image', 'link', 'advtable','|', 'fullscreen']});
	});
};
