...
CREATE TABLE `order` (
  ...
  `allowrefund` enum('Y','N') NOT NULL DEFAULT 'N' COMMENT 'æ˜¯å¦å…è®¸é€€æ¬¾',
  `rstate` enum('normal','askrefund','berefund','norefund') NOT NULL DEFAULT 'normal' COMMENT 'é€€æ¬¾çŠ¶æ€',
  `rereason` text,
  `retime` int(11) DEFAULT NULL COMMENT 'ç”³è¯·é€€æ¬¾æ—¶é—´',
...
CREATE TABLE `team` (
  ...
  `permin_number` int(10) unsigned NOT NULL DEFAULT '1',
...
-- Dump completed on 2011-07-15  9:59:34
